...
export default function SwapCard() {
  ...
  const [toToken, setToToken] = useState({ symbol: "DAI", balance: "0.0" });
  ...
  // Dummy balance fetching simulation
  useEffect(() => {
    // Simulate loading balances with dummy data
    const timer = setTimeout(() => {
      setFromToken((prev) => ({ ...prev, balance: "2.5" }));
      setToToken((prev) => ({ ...prev, balance: "1500" }));
    }, 1000);
